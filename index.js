...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//The reason why nested function can access the variable internal is because an inner function, which in this case is nestedFunction, can reach out of it's scope and used a variable that is defined in an outer function. So in this case nestedFunction is the inner function that is reaching out of it's inner scope and grabbing the defined variable internal, which is in an outer function myFunction. 
  ...
  */
  ...
  function animalNames(arr){
    ...
    arr.forEach(function(item){
      namesArr.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    })
    return namesArr
  }
